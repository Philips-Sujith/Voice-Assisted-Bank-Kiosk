"""
Comprehensive End-to-End Microservice System Integration Test Suite
Executes live HTTP and WebSocket interactions across all services:
...
SERVICES_CONFIG = [
    {
        "name": "Redis Broker",
        "cmd": [sys.executable, str(PROJECT_ROOT / "infrastructure" / "redis" / "run_redis.py")],
    ...
    },
    {
        ...
        "cwd": str(PROJECT_ROOT / "services" / "security"),
        "port": 8001,
    ...
    },
    {
        ...
        "cwd": str(PROJECT_ROOT / "services" / "identity"),
        "port": 8003,
    ...
    },
    {
        ...
        "cwd": str(PROJECT_ROOT / "services" / "banking-api"),
        "port": 8000,
    ...
    },
    {
        ...
        "cwd": str(PROJECT_ROOT / "services" / "voice"),
        "port": 8002,
...
class TestFullSystemIntegration(unittest.TestCase):
    ...
    def test_02_security_hmac_signing_contract(self):
        """Verify Security Service signs payloads and validates request schemas."""
    ...
    def test_03_voice_vernacular_intent_parsing(self):
        """Verify Voice Service parses English, Tamil, Tanglish and applies confidence logic."""
        session_id = str(uuid.uuid4())
