...
Checks required dependencies for all 6 Banking Kiosk modules and installs missing items.
"""
import os
import sys
import subprocess
...
def check_and_install():
    ...
    model_dirs = [
        os.path.join(base_dir, "AI-Based-Voice-Assisted-Kiosk-Prototype", "module4_face_auth", "models"),
        os.path.join(base_dir, "module4_face_auth", "models"),
    ]
