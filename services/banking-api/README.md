...
Core orchestration hub for the voice-assisted banking kiosk platform.  
Receives from **Voice Service** and **Identity Service**, sends to **Security Service**, pushes real-time events to the **Teller Portal & Hardware dashboards**.
...
Open **terminals** in `services/banking-api/`:
