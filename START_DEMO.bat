...
:: Locate active directory containing launcher_service.py
...
if not exist "%ACTIVE_DIR%\launcher_service.py" (
    if exist "%PROJECT_ROOT%\Bank_fixed_patch\launcher_service.py" (
        ...
        echo.
        echo ==============================================================================
        echo  ERROR: COULD NOT LOCATE BANKING KIOSK LAUNCHER FILES
        echo ==============================================================================
        echo Looking in: "%PROJECT_ROOT%"
        echo launcher_service.py was not found. Please ensure all project files are extracted.
        echo.
        pause
        popd
        exit /b 1
...
set "RUNTIME_DIR=%ACTIVE_DIR%\runtime"
...
if "!NEED_VENV_CREATE!"=="1" (
    ...
    if not exist "%VENV_PY%" (
        ...
        echo ==============================================================================
        echo Python could not initialize .venv in: "%ACTIVE_DIR%"
        echo.
        pause
        popd
        exit /b 1
...
if not exist "%RUNTIME_DIR%\.py_setup_done" (
    ...
    "%VENV_PY%" -u "%ACTIVE_DIR%\setup_env.py"
    if errorlevel 1 (
        echo.
        echo ==============================================================================
...
set "KIOSK_DIR="
if exist "%ACTIVE_DIR%\module-repos\Gopika_Module\package.json" (
    set "KIOSK_DIR=%ACTIVE_DIR%\module-repos\Gopika_Module"
) else if exist "%PROJECT_ROOT%\module-repos\Gopika_Module\package.json" (
    set "KIOSK_DIR=%PROJECT_ROOT%\module-repos\Gopika_Module"
) else if exist "%ACTIVE_DIR%\Bank_fixed_patch\module-repos\Gopika_Module\package.json" (
    set "KIOSK_DIR=%ACTIVE_DIR%\Bank_fixed_patch\module-repos\Gopika_Module"
) else if exist "%PROJECT_ROOT%\Bank_fixed_patch\module-repos\Gopika_Module\package.json" (
    set "KIOSK_DIR=%PROJECT_ROOT%\Bank_fixed_patch\module-repos\Gopika_Module"
) else if exist "%ACTIVE_DIR%\module1_customer_kiosk\package.json" (
    set "KIOSK_DIR=%ACTIVE_DIR%\module1_customer_kiosk"
)

:: Locate Staff Portal directory
set "STAFF_DIR="
if exist "%ACTIVE_DIR%\AI-Based-Voice-Assisted-Kiosk-Prototype\module6_staff_portal\package.json" (
    set "STAFF_DIR=%ACTIVE_DIR%\AI-Based-Voice-Assisted-Kiosk-Prototype\module6_staff_portal"
) else if exist "%PROJECT_ROOT%\AI-Based-Voice-Assisted-Kiosk-Prototype\module6_staff_portal\package.json" (
    set "STAFF_DIR=%PROJECT_ROOT%\AI-Based-Voice-Assisted-Kiosk-Prototype\module6_staff_portal"
) else if exist "%ACTIVE_DIR%\Bank_fixed_patch\AI-Based-Voice-Assisted-Kiosk-Prototype\module6_staff_portal\package.json" (
    set "STAFF_DIR=%ACTIVE_DIR%\Bank_fixed_patch\AI-Based-Voice-Assisted-Kiosk-Prototype\module6_staff_portal"
) else if exist "%PROJECT_ROOT%\Bank_fixed_patch\AI-Based-Voice-Assisted-Kiosk-Prototype\module6_staff_portal\package.json" (
    set "STAFF_DIR=%PROJECT_ROOT%\Bank_fixed_patch\AI-Based-Voice-Assisted-Kiosk-Prototype\module6_staff_portal"
) else if exist "%ACTIVE_DIR%\module6_staff_portal\package.json" (
    set "STAFF_DIR=%ACTIVE_DIR%\module6_staff_portal"
)
...
:: ------------------------------------------------------------------------------
pushd "%ACTIVE_DIR%"
"%VENV_PY%" -u "%ACTIVE_DIR%\launcher_service.py" start
popd
